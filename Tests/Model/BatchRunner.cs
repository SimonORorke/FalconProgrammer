...
public class BatchRunner {
  ...
  public void Run() {
    ...
    // batch.RollForward("Falcon Factory", "Bass-Sub", "100in1 1.4");
    // batch.RollForward("Falcon Factory", "Bass-Sub", "Balarbas 2.0");
    // batch.RollForward("Falcon Factory", "Brutal Bass 2.1", "808 Line");
    // batch.RollForward("Falcon Factory", "RetroWave 2.5", "BAS Hawkins Lab");
    // batch.RollForward("Falcon Factory", "RetroWave 2.5", "PAD Midnight Organ");
    // batch.RollForward("Falcon Factory", "VCF-20 Synths 2.5", "Bass Story");
    // batch.RollForward("Falcon Factory", "Vocal-Formant", "Vocal Growl Bass 1.6");
    ...
    // batch.RunTask(ConfigTask.QueryMainDahdsr, "Falcon Factory");
    // batch.RunTask(ConfigTask.ReplaceModWheelWithMacro, "Falcon Factory", "RetroWave 2.5", "PAD Midnight Organ");
