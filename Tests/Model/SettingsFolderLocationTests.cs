...
public class SettingsFolderLocationTests {
  ...
  public void Test1() {
    ...
    try {
      var location1 = SettingsFolderLocation.Read(FileSystemService.Default, SettingsTestHelper.TestApplicationName);
      ...
      var location2 = SettingsFolderLocation.Read(
        FileSystemService.Default, SettingsTestHelper.TestApplicationName);
