...
public class InfoPageLayout {
  ...
  public void ReplaceModWheelWithMacro() {
    ...
    MoveAllMacrosToStandardBottom();
    // if (Program.ContinuousMacros.Count > 3) {
    //   Program.Macros.Insert(
    //     Program.Macros.IndexOf(Program.ContinuousMacros[3]), wheelMacro);
    // } else {
    //   Program.Macros
    // }
    //
